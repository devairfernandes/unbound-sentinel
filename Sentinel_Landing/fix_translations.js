...
if (fs.existsSync(f)) {
    ...
    // Inject PT
    lang = lang.replace(
        /"faq\.a4": "O plano FREE oferece proteção DNS básica para.*?dashboard básico incluído\."\s*\n\s*\}/, 
